...
export const supplementStates: ChatState[] = [
  {
    ...
    options: [
      ...
      { id: 'sp_ai1', label: { en: 'AI Supplement Stack', ar: 'مكملات AI مخصصة' }, icon: '🧠', nextState: 'SP_AI_RECOMMEND',
...
export const programStates: ChatState[] = [
  {
    ...
    options: [
      ...
      { id: 'pg_ai1', label: { en: 'AI Program Recommendation', ar: 'ترشيح AI لبرنامج' }, icon: '🧠', nextState: 'PG_AI_RECOMMEND',
        condition: { type: 'tier', tier: 'PREMIUM_PLUS' } },
...
export const progressStates: ChatState[] = [
  {
    ...
    options: [
      ...
      { id: 'pr_ai1', label: { en: 'AI Weekly Report', ar: 'تقرير AI أسبوعي' }, icon: '🧠', nextState: 'PR_AI_WEEKLY',
        condition: { type: 'tier', tier: 'PREMIUM_PLUS' } },
