...
export const FEATURES: Feature[] = [
  ...
  // SMART FEATURES (Premium+ exclusive - the premium features)
  {
    ...
    name: 'Smart Coach',
    nameAr: 'المدرب الذكي',
    description: 'Get personalized workout suggestions tailored for you',
    descriptionAr: 'احصل على اقتراحات تمارين مخصصة لك',
    category: 'ai',
    tiers: ['FREE', 'PREMIUM', 'PREMIUM_PLUS'],
  ...
  },
  {
    ...
    name: 'Unlimited Smart Coach',
    nameAr: 'المدرب الذكي غير محدود',
    description: 'Unlimited personalized coaching with adaptive recommendations',
    descriptionAr: 'تدريب شخصي غير محدود مع توصيات متكيفة',
    category: 'ai',
    tiers: ['PREMIUM_PLUS'],
  },
  {
    id: 'form_checker',
    name: 'Auto Form Checker',
    nameAr: 'مدقق الشكل الآلي',
    description: 'App checks your exercise form automatically via video',
    descriptionAr: 'التطبيق يتحقق من شكل تمارينك تلقائياً عبر الفيديو',
    category: 'ai',
    tiers: ['PREMIUM_PLUS'],
  ...
  },
  {
    ...
    nameAr: 'تخطيط الوجبات الذكي',
    description: 'App creates meal plans tailored to your goals automatically',
    descriptionAr: 'التطبيق يصمم خطط وجبات مخصصة لأهدافك تلقائياً',
    category: 'ai',
    tiers: ['PREMIUM_PLUS'],
  },
  {
    id: 'ai_workout_generator',
    name: 'Auto Workout Creator',
    nameAr: 'منشئ التمارين الآلي',
    description: 'App creates custom workouts based on your equipment and goals',
    descriptionAr: 'التطبيق ينشئ تمارين مخصصة بناءً على معداتك وأهدافك',
    category: 'ai',
    tiers: ['PREMIUM_PLUS'],
  },
  {
    id: 'ai_progress_insights',
    name: 'Smart Progress Insights',
    nameAr: 'رؤى التقدم الذكية',
    description: 'App analyzes your fitness journey and gives you insights',
    descriptionAr: 'التطبيق يحلل رحلتك ويعطيك رؤى مفيدة',
    category: 'ai',
    tiers: ['PREMIUM_PLUS'],
  },
...
> = {
  ...
  ai: { name: 'Smart Features', nameAr: 'الميزات الذكية', icon: 'Sparkles' },
...
export const TIER_COMPARISON_HIGHLIGHTS = {
  ...
  PREMIUM: [
    ...
    'Ad-free experience',
    'Offline mode',
    '20 Smart Coach sessions/month',
  ],
  PREMIUM_PLUS: [
    'Everything in Premium, plus:',
    'Unlimited Smart Coach access',
    'Auto Form Checker (video analysis)',
    'Auto Workout Creator',
    'Smart Meal Planning',
