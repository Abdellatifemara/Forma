  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Edit Client Settings</h1>
          <p className="text-muted-foreground">Manage client goals and preferences</p>
        </div>
      ...
      <Card className="glass border-amber-500/30 bg-amber-500/5">
        <CardContent className="py-12">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">Client Settings Coming Soon</h2>
            <p className="text-muted-foreground max-w-md mx-auto mb-8">
              Edit client goals, update their fitness profile, and customize their training preferences.
            </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 max-w-3xl mx-auto">
              <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
                ...
                <p className="text-xs text-muted-foreground">Basic info & photos</p>
              </div>
              <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
                <Target className="h-6 w-6 text-purple-400 mx-auto mb-2" />
                <p className="font-medium text-sm">Goals</p>
                <p className="text-xs text-muted-foreground">Weight & fitness targets</p>
              </div>
              <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
                <Activity className="h-6 w-6 text-green-400 mx-auto mb-2" />
                <p className="font-medium text-sm">Training</p>
                <p className="text-xs text-muted-foreground">Schedule & preferences</p>
              </div>
              <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
