        ...
        >
            ...
            {isPaid && (
              <div className="text-right">
                <p className="text-2xl font-bold">
                  {subscription?.priceEGP || tierInfo.pricing.monthly} EGP
                </p>
          ...
          {isCancelled && (
            <div className="flex items-start gap-3 p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/30 mb-6">
              ...
              <div>
                <p className="font-medium text-yellow-500">Subscription Cancelled</p>
                <p className="text-sm text-muted-foreground">
                  Your access continues until {formatDate(subscription?.endDate || null)}.
          ...
          {/* Features */}
          <div className="mb-6">
            <p className="text-sm font-medium mb-3">Your features:</p>
              ...
              {payments.data.map((payment) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">{payment.amountEGP} EGP</p>
